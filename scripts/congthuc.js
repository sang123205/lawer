...
module.exports = {
  config: {
    ...
    role: 0,
    author: ['Lawer Team'],
    description: 'Công thức toán học - vật lý hoàn chỉnh',
    location: __filename,
    timestamps: 5
  }
};
module.exports.onReply = async function({ api, event, reply, global, is }) {
...
module.exports.onMessage = ({ event, api, args, global, is }) => {
  if (!args[0]) {
